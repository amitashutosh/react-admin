...
gulp.task('cpy-jsx', function() {
  gulp.src('lifelock-prebuild/scaffold/jsx/**/**/**').pipe(gulp.dest('src/jsx/'+argv.name));
});

gulp.task('cpy-sass', function() {
  gulp.src('lifelock-prebuild/scaffold/sass/**/**/**').pipe(gulp.dest('src/sass/'+argv.name));
});

gulp.task('create-locale-dir', function() {
  gulp.src('lifelock-prebuild/scaffold/public/**').pipe(gulp.dest('public/locales/'+argv.name));
});


gulp.task('create-fonts-dropbox', function() {
  gulp.src('lifelock-prebuild/scaffold/fonts/**').pipe(gulp.dest('public/fonts/dropbox/'+argv.name));
});
